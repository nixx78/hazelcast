...
public class CollectionsSandbox {
    ...
    @Test
    public void putAndCheckActionTest() {

        Person firstValue = personMap.put(1, new Person(1, "existing.value", null));
        Person existingValue = personMap.put(1, new Person(2, "new.value", null));

        assertNull(firstValue);
        assertEquals("existing.value", existingValue.getName());
